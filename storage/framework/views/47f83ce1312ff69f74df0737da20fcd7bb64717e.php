            ...
            <a href="#">
                ...
                <?php else: ?>
                    <?php if($item['title']=="Admin"): ?>
                        <span><?php echo e(\Encore\Admin\Facades\Admin::user()->name); ?></span>
                    <?php else: ?>
                        <span><?php echo e(admin_trans($item['title'])); ?></span>
                    <?php endif; ?>
                <?php endif; ?>
