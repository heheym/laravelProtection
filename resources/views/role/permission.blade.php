...
<script src="{{ URL::asset('js/jquery.ztree.core.min.js') }}"></script>
<script src="{{ URL::asset('js/jquery.ztree.excheck.min.js') }}"></script>
<link href="{{ URL::asset('css/zTreeStyle.css') }}" rel="stylesheet">
<body>
...
<script type="text/javascript">
    ...
    function onTreeClick(event, treeId, treeNode, clickFlag){
        ...
        if(rootnode.getCheckStatus().checked && !rootnode.getCheckStatus().half){
            $('form .box-body [name=permission]').remove();
            $('form .box-body').append("<input type='hidden' name='permission' value='1' >");
        }else{
            var c=[];
            ...
            $('form .box-body [name=permission]').remove();
            $('form .box-body').append("<input type='hidden' name='permission' value="+c+" >");
        }
    }
...
//        $.fn.zTree.init($("#tree"), setting, zNodes);
        ...
        if(che.length>0){
            ...
            $('form .box-body').append("<input type='hidden' name='permission' value="+che+" >");
        }
